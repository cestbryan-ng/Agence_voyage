...
const App2 = ({navigation}) => {
  ...
  const enregistrer = async () => {
    if (
      ...
      Alert.alert('Erreur saisie', 'Veuillez remplir les champs obligatoires.');
      return;
    }
    ...
    try {
      ...
      const apiUrl =
        'http://agence-voyage.ddns.net/api/utilisateur/inscription';
      ...
      if (
        ...
        Alert.alert(
          'Erreur',
          `Une erreur inattendue s'est produite: ${e.message}`,
        );
      }
    } finally {
      setLoading(false);
      ...
      <View style={styles.container3}>
        ...
        <View style={styles.genderContainer}>
          <TouchableOpacity
            style={[
              styles.genderButton,
              genre === 'MALE' ? styles.genderSelected : null,
            ]}
            onPress={() => setgenre('MALE')}>
            <Text
              style={[
                styles.genderText,
                genre === 'MALE' ? styles.genderTextSelected : null,
              ]}>
              Homme
            </Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={[
              styles.genderButton,
              genre === 'FEMALE' ? styles.genderSelected : null,
            ]}
            onPress={() => setgenre('FEMALE')}>
            <Text
              style={[
                styles.genderText,
                genre === 'FEMALE' ? styles.genderTextSelected : null,
              ]}>
              Femme
            </Text>
          </TouchableOpacity>
        ...
        {loading ? (
          <View style={[styles.loadingContainer, styles.btn]}>
